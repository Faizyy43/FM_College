...
//   return (
//     <div className="mt-8">
//       <h4 className="text-sm font-semibold text-slate-700 mb-3">Receipts</h4>
...
//                 onClick={() =>
//                   window.open(
//                     `http://localhost:5000/api/payments/receipt/${p._id}`,
//                     "_blank",
//                   )
//                 }
...
//               <a
//                 href={`http://localhost:5000/api/payments/receipt/${p._id}?download=true`}
//                 className="px-3 py-1 rounded-lg text-xs
