      ...
      <div className="max-w-6xl mx-auto p-6 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <GlassCard
            ...
            icon={<FaRegBuilding className="text-indigo-600" />}
          >
            <Info
              label="Types"
              value={establishmentType?.types?.join(", ")}
              icon={<BsPeople />}
            />
            {establishmentType?.otherType && (
              <Info
                label="Other"
                value={establishmentType.otherType}
                icon={<FiUser />}
              />
            )}
          </GlassCard>
          ...
          <GlassCard
            ...
            icon={<MdOutlineMeetingRoom className="text-purple-600" />}
          >
            <Info
              label="Classrooms"
              value={infrastructure?.classrooms}
              icon={<MdOutlineMeetingRoom />}
            />
            <Info
              label="Capacity"
              value={infrastructure?.capacity}
              icon={<BsPeople />}
            />
            <Info
              label="Staff"
              value={infrastructure?.staff}
              icon={<BsPeople />}
            />
            <Info
              label="Modes"
              value={infrastructure?.modes?.join(", ")}
              icon={<BsLaptop />}
            />
          </GlassCard>
        </div>
        ...
        <GlassCard
          title="Declarations"
          icon={<BsShieldCheck className="text-green-600" />}
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Status
              label="Info Correct"
              value={declarations?.infoCorrect}
              icon={<FiCheckCircle />}
            />
            <Status
              label="Agree Policy"
              value={declarations?.agreePolicy}
              icon={<FiCheckCircle />}
            />
            <Status
              label="Accept Terms"
              value={declarations?.acceptTerms}
              icon={<FiCheckCircle />}
            />
            <Info
              label="Declared At"
